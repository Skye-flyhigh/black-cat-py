...
This directory contains built-in skills that extend blackcat's capabilities.
...
When skills reference large local documentation or logs, prefer blackcat's built-in
