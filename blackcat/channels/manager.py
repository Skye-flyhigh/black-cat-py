...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import blackcat.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        from blackcat.channels.registry import discover_channel_names, discover_enabled
        ...
        for name, cls in discover_enabled(enabled_names, _names=names).items():
            ...
            try:
                ...
                if cls.name == "websocket":
                    from blackcat.channels.websocket import WebSocketConfig
