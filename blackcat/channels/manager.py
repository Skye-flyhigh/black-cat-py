...
class ChannelManager:
    ...
    _CHANNEL_REGISTRY: list[tuple[str, str, str]] = [
        ("telegram", "blackcat.channels.telegram", "TelegramChannel"),
        ("whatsapp", "blackcat.channels.whatsapp", "WhatsAppChannel"),
        ("discord", "blackcat.channels.discord", "DiscordChannel"),
        ("email", "blackcat.channels.email", "EmailChannel"),
    ]
