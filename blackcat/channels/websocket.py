"""WebSocket server channel: blackcat acts as a WebSocket server and serves connected clients."""
...
def _issue_route_secret_matches(headers: Any, configured_secret: str) -> bool:
    ...
    header_token = headers.get("X-Blackcat-Auth") or headers.get("x-blackcat-auth")
    if not header_token:
        return False
